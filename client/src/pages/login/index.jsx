...
function Login() {
    ...
    const handleGoogleLogin = async () => {
        try {
            ...
            const response = await axiosInstance.post('/api/firebase-login', { idToken });
        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex items-center justify-center p-4">
            ...
            >
                ...
                >
                    ...
                    <p className="text-gray-400">Continue your learning journey with AI</p>
                </motion.div>
                ...
                >
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="w-full pl-100 pr-4 py-3 bg-gray-700/50 border border-gray-600/50 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 transition-all duration-200"
                                    required
                                />
                            </div>
                        </div>
                        ...
                        <div className="space-y-2 my-3">
                            <label className="text-sm font-medium text-gray-300">Password</label>
                                ...
                                <div className="relative">
                                    ...
                                    className="w-full pl-4 pr-12 py-3 bg-gray-700/50 border border-gray-600/50 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 transition-all duration-200"
                                    required
                                    />
                                    ...
                                    className="absolute inset-y-0 right-0 flex items-center justify-center w-12 rounded-r-xl bg-gray-700/50 hover:bg-gray-700/70 transition-colors duration-200 text-gray-400 hover:text-gray-300"
                                    >
                                    {showPassword ? (
                    ...
                    <button
                        ...
                        className="w-full bg-white/10 hover:bg-white/20 border border-gray-600/50 text-white py-3 px-4 rounded-xl font-medium transition-all duration-200 flex items-center justify-center space-x-3 group"
                    >
